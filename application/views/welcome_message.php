...
<div id='content'>
    ...
    <div id='right_content'>
        ...
        <div class='login'>
            <?php echo  form_open('login', array('name'=>'signin', 'class'=>'login_form signin')) ?>
            ...
            <div class='cooper'>
                <p class='cooper_title'>Or 合作网站登录</p>
                    <a href="<?php echo $weibo_url?>" class="sina"></a>
        ...
        <div class='reg'>
            ...
            <?php echo  form_open('register', array('name'=>'signup', 'class'=>'login_form signup')) ?>
